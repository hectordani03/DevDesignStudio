  ...
  return (
    ...
    <section className='min-h-screen relative bg-emerald-400 dark:bg-slate-700 mt-20 flex flex-col lg:flex-row'>
      <section className='flex justify-center text-white flex-col lg:ml-10 items-center text-center mt-10 lg:mt-0 lg:items-start lg:text-start'>
        <h1 id='sobre-nosotros' className=' font-bold w-1/2 text-3xl sm:text-4xl md:text-6xl'>Sobre <span className='text-emerald-700 dark:text-emerald-400'>Nosotros</span></h1>
        ...
        <img className='lg:mr-20 mt-10 w-auto max-w-full h-auto' src={SvgInfo} alt="" />
    </section>
    <section className='dark:bg-slate-800'>
      <h1 className='text-4xl md:text-5xl font-bold mt-20 text-center dark:text-white'>Nuestro <span className='text-emerald-400'>Equipo</span></h1>
      <NuestroEquipo></NuestroEquipo>
    </section>

    <section className='flex mt-20 flex-col dark:bg-slate-800'>
    <h1 className='text-4xl md:text-5xl font-bold mt-20 text-center dark:text-white'>Contacta<span className='text-emerald-400'>nos</span></h1>
    ...
    <h1 id='preguntas-frecuentes' className='text-3xl sm:text-4xl md:text-5xl font-bold text-center mt-10 mb-16 dark:text-white'>Preguntas <span className='text-emerald-400'>Frecuentes</span></h1>
      {
