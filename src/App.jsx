...
function App() {
  ...
  return (
    ...
    <h1 className='text-3xl sm:text-4xl md:text-5xl font-bold text-center mt-10 mb-16 dark:text-white'>Preguntas <span className='text-emerald-400'>Frecuentes</span></h1>
      {
