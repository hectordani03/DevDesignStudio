...
export const Home = ({ theme }) => { // Recibe 'theme' como una prop
  ...
  return (
    <section className='min-h-screen relative dark:bg-slate-800'>
      ...
      <img
        className={`w-auto max-w-full h-auto sm:mr-12 lg:mr-0 scroll-animation`}
